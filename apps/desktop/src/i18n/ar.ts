...
export const ar = defineLocale({
  ...
  settings: {
    ...
    fieldLabels: {
      ...
      'memory.memoryEnabled': 'ذاكرة الوكيل',
      'memory.memoryCharLimit': 'ميزانية ذاكرة الوكيل',
      'memory.userProfileEnabled': 'ذاكرة ملف المستخدم',
      'memory.userCharLimit': 'ميزانية ذاكرة ملف المستخدم',
